...
module OV7670_setup_CNTL #(
    ...
    always_comb begin
        ...
        case (config_idx)
            ...
            // Color Matrix (Adjust color saturation for RGB565)
            60 : begin reg_addr = 8'h4F; reg_data = 8'hB3; end // Matrix Coefficient 1
            61 : begin reg_addr = 8'h50; reg_data = 8'hB3; end // Matrix Coefficient 2
            62 : begin reg_addr = 8'h51; reg_data = 8'h00; end // Matrix Coefficient 3
            63 : begin reg_addr = 8'h52; reg_data = 8'h3D; end // Matrix Coefficient 4
            64 : begin reg_addr = 8'h53; reg_data = 8'hA7; end // Matrix Coefficient 5
            65 : begin reg_addr = 8'h54; reg_data = 8'hE4; end // Matrix Coefficient 6
            66 : begin reg_addr = 8'h58; reg_data = 8'h9E; end // Matrix Sign option
