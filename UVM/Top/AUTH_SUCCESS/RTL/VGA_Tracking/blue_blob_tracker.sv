    ...
    always_ff @(posedge i_pclk or negedge i_rst_n) begin
        if (!i_rst_n) begin
            ...
            if (frame_start) begin
                // Output the previous frame result.
                if (frame_seen &&
                ...
                // Clear accumulators for the new frame.
                pixel_x <= '0;
                pixel_y <= '0;
                ...
                // Accumulate the blue-pixel bounds and count.
                if (i_is_blue) begin
                ...
                // Advance the current pixel position.
