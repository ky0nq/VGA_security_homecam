...
HD_PWD='D:/OndeviceAI/0902_Video_Datapath/0902_Video_Datapath.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log video_path.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source video_path.tcl -notrace
