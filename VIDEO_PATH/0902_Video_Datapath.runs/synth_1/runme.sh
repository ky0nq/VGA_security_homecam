...
HD_PWD='D:/OndeviceAI/0902_Video_Datapath/0902_Video_Datapath.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log video_path.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source video_path.tcl
