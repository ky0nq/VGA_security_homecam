...
// Color filter. Turns the picture blue when blue_en is high, passes it through otherwise
...
module blue_filter_pipe (
    ...
    // Stage 2 : add up the brightness, then spread it into a blue tone, and pick output
    logic [11:0] y_sum;
    logic [ 3:0] gray;
    ...
    assign blue_b = gray;                  // gray * 1.0 (dominant channel)
